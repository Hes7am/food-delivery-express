...
--
-- Host: localhost
-- Generation Time: Jun 20, 2024 at 01:22 PM
...
INSERT INTO `food_orders` (`id`, `Naam`, `Telefoonnummer`, `Betalingopties`, `Bezorgmethode`, `Woonplaats`, `Postcode`, `Huisnummer`) VALUES
(1, 'Othmane Aissaoui', '546789', 'paytm', 'pickup', 'utrecht', '3527RG', 'Adena'),
(2, 'Othmane Aissaoui', '35876978567453642', 'paytm', 'delivery', 'utrecht', '3527RG', 'Adena'),
(3, 'Othmane Aissaoui', '35876978567453642', 'paytm', 'delivery', 'utrecht', '3527RG', 'Adena'),
(4, 'khalil', '0999999993', 'paypal', 'pickup', 'maarsen', '4324DF', '224'),
(6, 'Othmane', '111111111111111111', 'credit card', 'pickup', 'weee', '1111rt', '1111'),
(7, 'semmu', '321', 'cash on delivery', 'delivery', '1', '321', '321');
...
--
-- Table structure for table `gastenboek_entries`
--
...
--
-- Dumping data for table `gastenboek_entries`
--
...
--
-- Table structure for table `gastenboek_users`
--
...
--
-- Dumping data for table `gastenboek_users`
--
...
--
-- Indexes for table `gastenboek_entries`
--
ALTER TABLE `gastenboek_entries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `gastenboek_users`
--
...
--
-- AUTO_INCREMENT for table `gastenboek_entries`
--
ALTER TABLE `gastenboek_entries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `gastenboek_users`
--
ALTER TABLE `gastenboek_users`
